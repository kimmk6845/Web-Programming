...
--  delete from QUIZ where Q_NUM=33;
    -- Drop table SCORE;
...
-- delete from SCORE where S_NUM=12;
...
Insert into QUIZ(Q_NUM, Q_QUESTION, Q_TYPE, Q_EX1, Q_EX2, Q_EX3, Q_EX4, Q_ANSWER) Values(9, '다음중 박명수는 ?', 'TI', 'pa.jpg','yu.jpg', 'so.jpg', 'ca.jpg', 'pa.jpg');
...
Insert into SCORE(S_NUM, S_Name, S_GRADE) Values(0,'admin*',100);
-- SELECT * FROM quiz;
-- DROP TABLE quiz;
